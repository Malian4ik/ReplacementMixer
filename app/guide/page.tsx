...

  {
    ...
    a: (
      <ul style={{ margin: 0, paddingLeft: 18, lineHeight: 2 }}>
        <li>Вручную — судья или овнер добавляет игрока через <b>/pool → кнопка «Добавить»</b></li>
        <li>Кнопкой <b>«В пул замен»</b> на странице Игроки — автоматически добавляет всех активных игроков, которые не состоят ни в одной команде</li>
        <li>Автоматически — после того как игрока заменили в команде, он сразу встаёт в <b>конец</b> пула</li>
        <li>При возврате в пул его <b>счётчик ночных матчей обнуляется</b></li>
        <li>Порядок в пуле строго по времени входа — изменить вручную может только OWNER</li>
      </ul>
    ),
  },
  {
