...
const FAQ: FaqItem[] = [
  ...
  {
    tag: "Технические",
    q: "Когда приходит ежедневный отчёт в Telegram?",
    a: (
      <>
        Отчёт отправляется автоматически каждый день в <b>00:00 по Москве</b> (21:00 UTC).
        На бесплатном тарифе Vercel cron-задачи могут задерживаться на 15–45 минут —
  ...
  },
  {
    ...
    a: (
      <ul style={{ margin: 0, paddingLeft: 18, lineHeight: 2 }}>
        ...
        <li>При любых проблемах с данными — обращайся к OWNER</li>
      </ul>
    ),
  },
];
