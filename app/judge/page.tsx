...
export default function JudgePage() {
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div className="judge-cols" style={{ flex: 1, overflow: "hidden", display: "grid", gridTemplateColumns: "260px minmax(0, 560px) 380px", gridTemplateRows: "1fr", gap: 12, padding: "12px 16px" }}>
